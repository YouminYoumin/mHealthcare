...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db){ // Create database and table
        ...
        db.execSQL("INSERT INTO USERLIST VALUES(5, 'rosa117', '123456');");
        ...
        db.execSQL("INSERT INTO USERINFO VALUES('rosa117', 'Rosa', 28, 'researcher', 'female', 'Rosa117@gmail.com', 'la trobe');");
        ...
        db.execSQL("INSERT INTO PATIENTINFO VALUES(9, 'Andy', 12, 'male', 'cold', 38, 'none', '99999999');");
        ...
        db.execSQL("INSERT INTO TIME VALUES('researcher', '9-00', '21-00');");
        ...
        db.execSQL("INSERT INTO CONTEXT VALUES('researcher', 'time');");
    ...
    public boolean getLogin(String user_id, String password){ // Check whether user can log on
        ...
        else{ // If password is different with parameter
            fulldb.close();
            return false;
        }
    }
    ...
    public ArrayList<String> getResult(String patientnum, String user_id){ // Return patient information
        ...
        else if(c.getString(c.getColumnIndex("auth")).equals("researcher")){ // If user is a researcher, get 3 information
            sql = "SELECT name, age, disease FROM PATIENTINFO WHERE patientnum = '" + patientnum + "'";
        }
